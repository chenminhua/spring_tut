package com.chenminhua.utilexamples;
...
public class Main {
    ...
    public static class SimpleRestController {
        ...
        void hi (HttpServletRequest request) {
            ...
            log.info("temp dir for apache tomcat is " + tempDir.getAbsolutePath());
    ...
    private void systemPropertyUtils() {
        String resolvedText = SystemPropertyUtils.resolvePlaceholders("my home dir is ${user.home}");
    ...
    private void beanUtils(DemoClass demo) {
        ...
        for (PropertyDescriptor pd : descriptors) {
            log.info("pd.getName() : " + pd.getName());
            //log.info("pd.getMethodName() : " + pd.getReadMethod().getName());
